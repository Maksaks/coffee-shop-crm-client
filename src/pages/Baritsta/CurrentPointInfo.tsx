...
const CurrentPointInfo: FC = () => {
	...
	return (
		<motion.div
			...
			className='w-[70%] h-[1000px] mt-20 mx-auto text-white flex font-roboto bg-zinc-700 rounded-2xl py-5 flex-col'
		>
			...
			<div className='flex h-[90%] w-full justify-start px-28'>
				<div className='w-[30%] h-full border-r-4'>
					...
					<div className='w-full h-[20%] py-5 flex flex-col items-center border-b-4 justify-center'>
						<label className='flex items-center pl-3 w-[80%] uppercase font-bold text-2xl'>
							Point balance:
						</label>
						<label className='col-span-4 w-[80%] h-[55px] bg-gradient-to-r from-zinc-500 to-zinc-400 flex items-center p-3 rounded-2xl cursor-default placeholder:text-black/50 placeholder:text-lg text-2xl'>
					...
					<div className='w-full h-[30%] flex flex-col items-center justify-center'>
						<label
							htmlFor='takingMoney'
							className='text-left w-[80%] pl-3 uppercase font-bold text-2xl'
						>
							withdrawal amount
						</label>
						<input
							...
							className='w-[80%] p-3 rounded-2xl text-black placeholder:text-xl'
				...
				<div className='grid grid-cols-5 w-[70%] px-16 pt-16 text-xl max-h-[70%]'>
					...
					<label className='col-span-4 w-full h-[55px] bg-gradient-to-r from-zinc-500 to-zinc-400 flex items-center p-3 rounded-2xl cursor-default placeholder:text-black/50 placeholder:text-lg text-2xl'>
						{point.name}
					</label>
					...
					<label className='col-span-4 max-h-full min-h-[55px] overflow-auto bg-gradient-to-r from-zinc-500 to-zinc-400 px-3 py-3 rounded-2xl cursor-default placeholder:text-black/50 placeholder:text-lg text-2xl'>
						{point.description}
					</label>
				</div>
			</div>
