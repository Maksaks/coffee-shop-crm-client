...
const Expenses: FC = () => {
	...
	return (
		...
		>
			<div className='h-[100%] w-[40%] bg-zinc-600 rounded-3xl flex items-center flex-col relative shadow-2xl'>
			...
			<div className='h-[100%] w-[60%] bg-zinc-600 rounded-3xl flex items-center flex-col relative shadow-2xl'>
				<h2 className='w-full text-center text-[2vh] uppercase font-bold border-b-4 p-3'>
				...
				{selectedPoint && (
					<div className='grid grid-cols-6 gap-2 p-3 w-full border-b-4'>
						...
						<input
							className='col-span-4 p-1 text-[1.7vh] rounded-xl text-black'
							type='datetime-local'
							value={fromDate}
						...
						<input
							className='col-span-4 p-1 rounded-xl text-[1.7vh] text-black'
							type='datetime-local'
							value={toDate}
				...
				{selectedPoint && (
					<div className='w-[80%] mt-10 border-2 h-[70%] grid grid-cols-6 text-center text-[2vh]'>
